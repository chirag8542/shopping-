...
<html lang="en">
	<head>
	    ...
	    <title> your Product Details</title>
					...
					<div class="products">
						...
						<div class="cart clearfix animate-effect">
							...
							<button class="btn btn-primary" type="button"> cart</button></a>
								<?php } else {?>
							<div class="action" style="color:red"> Stock over </div>
					<?php } ?>
...
?>		
							<div class="rating-reviews m-t-20">
								<div class="row">
									...
									<div class="col-sm-8">
										<div class="reviews">
											<a href="#" class="lnk">(<?php echo htmlentities($num);?> your  Reviews)</a>
										</div>
									</div>
								</div><!-- /.row -->		
							</div><!-- /.rating-reviews -->
...
<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label"> blackbird Shipping Charge :</span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
...
<?php if($row['productAvailability']=='In Stock'){?>
					...
					<?php } ?>
							...
							<div class="product-social-link m-t-20 text-right">
								<span class="social-label">offer :</span>
